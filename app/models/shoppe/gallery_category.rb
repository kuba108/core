module Shoppe
  ...
  class GalleryCategory < ActiveRecord::Base
    ...
    has_attached_file :image, :styles => { :medium => "500x673#", :thumb => "253x340#", :original => "892x1200#" },
                      :default_url => "/photos/default/:style/gallery-default.jpg",
                      :url => "/photos/galleries/:id/:style/:basename.:extension",
                      :path => ":rails_root/public/photos/galleries/:id/:style/:basename.:extension"
